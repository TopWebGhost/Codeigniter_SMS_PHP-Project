...
<head>
    ...
    <title><?php echo appconfig('CompanyName') ?> | <?php echo $Lan['Admin_Login']; ?></title>
    ...
    <div class="middle-login">
        <div class="block-flat">
            ...
            <div>
                ...
                <form style="margin-bottom: 0px !important;" class="form-horizontal" action="<?php echo $self; ?>" method="get">
                    <div class="content">
                        <h4 class="title"><?php echo $Lan['Login_to']; ?> <?php echo appconfig('CompanyName') ?> <?php echo $Lan['Dashboard']; ?></h4>
                    ...
                    <div class="foot">
                        ...
                        <a class="btn btn-default" href="admin-password-forget.php"><?php echo $Lan['Forgot_Password']; ?>?</a>
