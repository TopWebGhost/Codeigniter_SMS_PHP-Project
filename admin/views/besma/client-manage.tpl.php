...
?>
                    ...
                    <div class="col-sm-10">
                        <div class="personal">
                            ...
                            <p>
                                ...
                                <button type="button" class="btn btn-default btn-large md-trigger" data-modal="form-gateway"><i class="fa fa-exchange"></i>  <?php echo $Lan['Change_Gateway']; ?></button>
    ...
    <ul class="nav nav-tabs">
        ...
        <li><a data-toggle="tab" href="#tickets"><?php echo $Lan['Latest_Tickets']; ?></a></li>
        ...
        <li><a data-toggle="tab" href="#invoice"><?php echo $Lan['Latest_Invoices']; ?></a></li>
            ...
            <tr>
                ...
                <td>
                    <table class="no-border no-strip skills">
                        ...
                        <tr><td style="width:20%;"><b><?php echo $Lan['Email_Gateway']; ?></b></td><td><?php echo $cquery['email_gateway']; ?></td></tr>
                        <tr><td style="width:20%;"><b><?php echo $Lan['SMS_Gateway']; ?></b></td><td><?php echo $cquery['sms_gateway']; ?></td></tr>
                         </tbody>
                    </table>
                </td>
            </tr>
    ...
    <div id="tickets" class="tab-pane cont">
        ...
        <div class="block-flat">
            <div class="content">
                <table class="no-border">
                    ...
                    <tr>
                        <th style="width:50%;"><?php echo $Lan['Subject']; ?></th>
                        <th><?php echo $Lan['Date']; ?></th>
                        <th class="text-right"><?php echo $Lan['Status']; ?></th>
                    </tr>
                    </thead>
                    <tbody class="no-border-x no-border-y">
                    <?php
                    $rwcount=count($tquery);
                    if ($rwcount>0) {
                        foreach ($tquery as $value) {
                            $status=$value['status'];
                            $tid=$value['id'];
                            $tdate=$value['date'];
                            ...
                            ?>
                            <tr>
                                <td style="width:30%;"><a href="support-ticket-manage.php?_stid=<?php echo $tid; ?>"> <?php echo $tsubject; ?></a></td>
                        ...
                        ?>
                        <td colspan='3'><?php echo $Lan['Have_no_Tickets']; ?></td>
                    <?php
                    }
                    ?>
                    </tbody>
    ...
    <div id="invoice" class="tab-pane cont">
                ...
                <table class="no-border">
                    ...
                    if ($incount>0) {
                        foreach ($invoice as $value) {
                            ...
                            <tr>
                                <td ><?php echo $inid; ?></td>
                                <td><a href="invoice-manage.php?_inid=<?php echo $inid; ?>"> <?php echo $item; ?></a></td>
                                <td ><?php echo $amount; ?></td>
                                <td><?php echo $date; ?></td>
                                <td class="text-right">
                        ...
                        ?>
                        <td colspan='3'><?php echo $Lan['No_Invoice']; ?></td>
                    <?php
                    }
                    ?>
                    </tbody>
    ...
    <div id="settings" class="tab-pane">
        <form role="form" class="form-horizontal group-border-dashed"  method="post" action="<?php echo 'update-client.php?_id='.$cmd; ?>">
    ...
    <div class="col-sm-4 side-right">
        ...
        <div class="block-flat bars-widget">
            <div class="spk5 pull-right">
                <h4><?php echo $Lan['Closed']; ?></h4>
                <h3><?php echo $closed_ticket; ?></h3>
            </div>
            <h4><?php echo $Lan['Total_Ticket_Create']; ?></h4>
    ...
    <div class="md-modal colored-header custom-width md-effect-9" id="form-green">
        <form class="form-horizontal group-border-dashed" autocomplete="off" action="single-email-send.php?_clid=<?php echo $cmd; ?>" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate novalidate accept-charset="UTF-8">
            <div class="md-content">
                <div class="modal-header">
                ...
                <div class="modal-body form">
                    ...
                    <div class="form-group">
                        <label><?php echo $Lan['Select_Email_Provider']; ?></label>
    ...
    <div class="md-modal colored-header custom-width md-effect-9" id="form-sms">
        <form class="form-horizontal group-border-dashed" autocomplete="off" action="single-sms-send.php?_clid=<?php echo $cmd; ?>" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate novalidate>
            <div class="md-content">
                <div class="modal-header">
                ...
                <div class="modal-body form">
                    ...
                    <div class="form-group">
                        <label><?php echo $Lan['Select_SMS_Gateway']; ?></label>
    ...
    <div class="md-modal colored-header custom-width md-effect-9" id="form-gateway">
        <form class="form-horizontal group-border-dashed" action="change-gateway.php?_clid=<?php echo $cmd; ?>" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate novalidate>
            <div class="md-content">
                <div class="modal-header">
                            ...
                            <?php
                                $sms_gat=ORM::for_table('sms_gateway')->where('status','Active')->find_many();
                                    foreach($sms_gat as $sgn){
                                        $smgname=$sgn['name'];
                                        ?>
                                        <option value="<?php echo $smgname; ?>"  <?php  if($smgname==$cquery['sms_gateway']){echo 'selected';} ?> ><?php echo $smgname; ?></option>
                                    <?php
                                    }
                            ?>
                        </select>
                        ...
                        <select class="select2" name="email_gateway">
                            ...
                            <?php
                                ...
                                foreach($sms_gat as $sgn){
                                    $smgname=$sgn['name'];
                                    ?>
                             <option value="<?php echo $smgname; ?>" <?php  if($smgname==$cquery['email_gateway']){echo 'selected';} ?>><?php echo $smgname; ?></option>
                                <?php
                                }
                            ?>
                            </select>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-flat md-close" data-dismiss="modal"><?php echo $Lan['Cancel']; ?></button>
                    <button type="submit" class="btn btn-primary btn-flat md-close" data-dismiss="modal" name="submit"><?php echo $Lan['Update']; ?></button>
                </div>
        </form>
    </div>
    </div>
