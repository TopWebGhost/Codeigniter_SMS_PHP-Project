            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="block-flat">
                        ...
                        <div class="content">
                        <form class="form-horizontal group-border-dashed" role="form"  parsley-validate novalidate action="add-country.php" method="post">
                               ...
                               <select name="country" class="select2">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-9">
                                        <button type="submit" class="btn btn-primary" name="submit" >Add Country</button>
