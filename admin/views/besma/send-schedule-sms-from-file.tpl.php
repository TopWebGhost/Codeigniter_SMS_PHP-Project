...
?>
    ...
    <div class="container-fluid" id="pcont">
        <div class="page-head">
            <h2><?php echo $Lan['schedule_sms_from_file']; ?></h2>
            <ol class="breadcrumb">
                <li><a href="index.php"><?php echo $Lan['Home']; ?></a></li>
                <li class="active"><?php echo $Lan['schedule_sms_from_file']; ?></li>
            </ol>
        </div>
        <div class="cl-mcont">
            <?php notify(); ?>
                ...
                <div class="col-md-12 fuelux">
                    <div class="block-wizard">
                        ...
                        <div class="step-content">
                            <form class="form-horizontal group-border-dashed" action="schedule-sms-send-from-file.php" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate novalidate enctype="multipart/form-data" accept-charset="UTF-8">
            ...
            <div class="md-modal colored-header custom-width md-effect-9" id="form-primary">
                <div class="md-content">
                    ...
                    <div class="modal-body form">
                        <div class="form-group">
                            <img src="../assets/sms_file/notepad.jpg"  class="profile-avatar img-thumbnail align-center">
                        </div>

                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary btn-flat md-close" data-dismiss="modal"><?php echo $Lan['Cancel']; ?></button>
                        <a type="button" class="btn btn-danger btn-flat md-close" href="sms-download-file.php?_xClick=test file.txt"><?php echo $Lan['Download']; ?></a>
                    </div>
                </div>
            </div>
