...
?>
    ...
    <div class="container-fluid" id="pcont">
        <div class="page-head">
            <h2><?php echo $Lan['All_Pending_Tickets']; ?></h2>
            <ol class="breadcrumb">
                <li><a href="index.php"><?php echo $Lan['Home']; ?></a></li>
                <li class="active"><?php echo $Lan['All_Pending_Tickets']; ?></li>
            </ol>
        </div>
        <div class="cl-mcont">
            <?php notify(); ?>
            <div class="row">
                <div class="col-md-12">
                    <div class="block-flat">
                        <div class="header">
                            <h3><?php echo $Lan['All_Pending_Tickets']; ?></h3>
                        </div>
                        <div class="content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="datatable" >
                                    ...
                                    <tbody>
                                    <?php
                                    $cl=ORM::for_table('tickets')->where('status','Pending')->find_many();
                                    $clcount=count($cl);
                                    $serial=0;
                                    if ($clcount>0) {
                                        foreach ($cl as $value) {
                                        ...
                                        ?>
                                        <td><?php echo $Lan['No_Pending_Support_Tickets']; ?></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
