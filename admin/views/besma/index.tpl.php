      ...
      <?php notify(); ?>
        ...
        <div class="row dash-cols">
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="block">
                    <div class="header">
                        <h2><i class="fa fa-user"></i><?php echo $Lan['CLIENT_INFO']; ?></h2>
                    </div>
                    <div class="content no-padding">
                        <div class="fact-data text-center">
                            <h3><?php echo $Lan['Clients']; ?></h3>
                            <h2><?php echo $allclientcount; ?></h2>
                            <h4><a href="all-clients.php"> <?php echo $Lan['View_All']; ?></a></h4>
                        </div>
                        <div class="fact-data text-center">
                            <h3><?php echo $Lan['Groups']; ?></h3>
                            <h2><?php echo $allgroupcount; ?></h2>
                            <h4><a href="all-groups.php"> <?php echo $Lan['View_All']; ?></a></h4>
                        </div>
                    </div>
                </div>
            </div>
