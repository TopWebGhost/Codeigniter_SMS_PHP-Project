    ...
    if($gateway=='NibsSMS'){
        ...
        foreach($clgroupres as $value) {
            ...
            if($sms_cost){
                ...
                $total_charge=$sms_charge*$listcount;
            }else{
        ...
        if($sms_count>=$total_charge) {
            ...
            conf('send-bulk-sms.php','e','You Do Not Have Enough Balance to sent this SMS');
        }
    }
