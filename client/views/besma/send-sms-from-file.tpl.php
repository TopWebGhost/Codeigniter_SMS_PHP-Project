...
?>
    ...
    <div class="container-fluid" id="pcont">
        <div class="page-head">
            <h2><?php echo $Lan['Send_SMS_From_File']; ?></h2>
            <ol class="breadcrumb">
                <li><a href="index.pp"><?php echo $Lan['Home']; ?></a></li>
                <li class="active"><?php echo $Lan['Send_SMS_From_File']; ?></li>
            </ol>
        </div>
        <div class="cl-mcont">
            <?php notify(); ?>
                ...
                <div class="col-md-12 fuelux">
                    <div class="block-wizard">
                        ...
                        <div class="step-content">
                            <form class="form-horizontal group-border-dashed" action="sms-send-from-file.php" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate novalidate enctype="multipart/form-data" accept-charset="UTF-8">
